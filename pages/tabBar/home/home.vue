	...
	<view>
		...
		<view class="swiper">
			<view class="swiper-box">
				<swiper circular="true" autoplay="true" indicator-color="" indicator-active-color="#fff" :indicator-dots="indicatorDots"
				 @change="swiperChange">
		...
		<view class="garbageCategory">
			<view class="garbageContent">
				<view class="titleview">
					<view class="text">垃圾分类</view>
				</view>
				<view class="inputview" @tap="toPage">
				...
				<view class="garbageKnowage">
					<view class="kowageContent">
						<view class="img">
		...
		<view class="recycling">
			<view class="recylingContent">
				<view class="titleview">
					<view class="text">回收服务</view>
				</view>
				<view class="merchantService">
